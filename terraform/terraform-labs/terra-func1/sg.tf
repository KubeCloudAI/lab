# TOPICS: DYNAMIC BLOCKS, FOR_EACH, LIST
...
resource "aws_security_group" "allow_all" {
  ...
  # TOPIC: DYNAMIC BLOCK - Similar to for_each for generating nested blocks
  ...
  dynamic "ingress" {
    for_each = var.ingress_ports  # LIST: iterable collection of port numbers
    content {
