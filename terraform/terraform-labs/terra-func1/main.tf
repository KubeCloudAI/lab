...
# TOPIC: LOCALS
# Description: Static values defined in local.tf that are reused throughout configuration
# Provides consistency for tags and other repeated values
# Referenced as local.owner, local.costcenter, local.Teamdl
